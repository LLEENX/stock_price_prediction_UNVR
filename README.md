...
- iₜ: seberapa besar informasi baru yang disimpan  
- ĉₜ: kandidat informasi baru yang ingin ditambahkan ke *cell state*  
- Wᵢ, W꜀: bobot input gate dan candidate  
- bᵢ, b꜀: bias masing-masing
